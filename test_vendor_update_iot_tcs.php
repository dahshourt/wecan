...
echo "=== Testing Vendor Update IOT TCs Logic (completes IOT In progress) ===\n";
...
echo "\n4. Testing Vendor Review → Update IOT TCs transition (should complete all other statuses)...\n";
$statusData = [
