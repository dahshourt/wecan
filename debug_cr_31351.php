...
echo "2. All Active Status Records:\n";
$statusRecords = \App\Models\Change_request_statuse::where('change_request_id', $crId)
...
$iotStatusRecords = \App\Models\Change_request_statuse::where('change_request_id', $crId)
...
$qcPendingActive = \App\Models\Change_request_statuse::where('change_request_id', $crId)
    ->where('status_id', 336) // Pending IOT TCs Review QC
    ->where('active', 1)
    ->exists();

$saPendingActive = \App\Models\Change_request_statuse::where('change_request_id', $crId)
...
$recentRecords = \App\Models\Change_request_statuse::where('change_request_id', $crId)
    ->orderBy('created_at', 'desc')
    ->limit(10)
    ->get();
